...
```json
"features": {
    "ghcr.io/hprtama/devcontainer-features/docker-in-docker:0": {}
}
```
...
| legacyIptables | Swap to legacy iptables for compatibility (Debian only) | boolean | false |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/hprtama/devcontainer-features/blob/main/src/docker-in-docker/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
